...
export const translations = {
  en: {
    ...
    dashboard: {
      ...
      unenrollModalText: "{title} will move to your Unenrolled tab. Your progress and XP are kept, and you can rejoin anytime.",
  ...
  es: {
    ...
    dashboard: {
      ...
      unenrollModalText: "{title} pasará a tu pestaña Cancelados. Tu progreso y XP se conservan, y puedes volver cuando quieras.",
