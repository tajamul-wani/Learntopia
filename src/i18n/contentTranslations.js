  ...
  en: {
    ...
    doc: {
      ...
      features: [
        ...
        { title: "AI Tutor", text: "Leo is the AI tutor across every course. Each question carries the course and the module you are on, so answers stay on the subject you are studying." },
  ...
  es: {
    ...
    doc: {
      ...
      features: [
        ...
        { title: "Tutor con IA", text: "Leo es el tutor con IA de todos los cursos. Cada pregunta lleva el curso y el módulo en el que estás, así que las respuestas se mantienen en la materia que estudias." },
